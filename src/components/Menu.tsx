    ...
    <div>
      <button
        ...
        className={`relative group inline-block transition-all z-40 duration-500 ${
          isFullyOpen ? "text-black" : "text-[#111111] "
      ...
      <div
        ref={menuRef}
        className="menu fixed top-0 lg:pt-0 pt-20 right-0 h-full flex flex-col justify-between  lg:w-2/3 w-full bg-white shadow-lg transition-none z-30"
        style={{ transform: "translate(100%, -100%)" }}
      >
        <Link
          href="/"
          className={`text-2xl text-black lg:hidden inline  absolute top-5 font-bold left-5 transition-all duration-500 ${
        ...
        <ul className="p-6 lg:pt-15 pt-10  text-[6vw] lg:text-[4vw] flex flex-col">
